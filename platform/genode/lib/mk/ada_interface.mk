...
SRC_ADS += cxx.ads \
	   ...
	   cai-configuration.ads \
	   cxx-configuration.ads \
	   cxx-configuration-client.ads \
	   cai-internal-configuration.ads
...
vpath cai-configuration-client.adb $(CAI_CONFIG_DIR)/client/genode
